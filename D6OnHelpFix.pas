...
Mini Tutorial:
  ...
  6/Jan/2006 - A couple of users found a small memory leak or 20 bytes in THelpSelector.
    User have added HelpSelector._Release to the finalization secion of the unit to fix this.
    I'm not convinced it is necessary but if you want to fix the 20 bytes of memory leak then
    simply uncomment the //HelpSelector._Release line below.
