{
  Copyright © 2000-01 Grega Loboda
  grega.loboda@email.si
  Version 1.12
  Last modified: 23.04.2004
  TdsTaskBar

  version 1.01 (Willy Angenent - Willy.Angenent@wxs.nl)
  ------------
  - Added support for form icons
  - Added support for form mini and maximization
  - Fixed bug involving button text truncation after resizing

  version 1.02 (Grega Loboda - grega.loboda@email.si)
  ------------
  - Added auto create buttons option

  version 1.03 (Roman Kovbasiouk - roman@elsyst.km.ua)
  ------------
  - Added child's system menu invocation on right-click of TTaskBarButton
  - Added OnDeactivate tracking to prevent buttons from staying pressed
    after form was deactivated
  - Some code optimizations

  version 1.04 (Thomas Bräuner - braeuner@bender-und-stahl.de)
  ------------
  - Changed Hint := AForm.Caption to Hint := AForm.Hint
  - Few ideas which will be implemented in version 1.05

  version 1.05 (Grega Loboda - grega.loboda@email.si)
  ------------
  - Added event OnCreateButton
  - Added function ButtonByForm
  - Added Emulate (to emulate behaviour of other applications)

  version 1.06 (Grega Loboda - grega.loboda@email.si)
  ------------
  - Added FullText property to TTaskBarButton and ResetCaption

  version 1.07 (Grega Loboda - grega.loboda@email.si)
  ------------
  - Some bug fixes and functionality that is not really important
    to describe

  version 1.08 (Grega Loboda - grega.loboda@email.si)
  ------------
  - Changes how form reacts when form is active and button is pressed
  - Property to scroll buttons captions

  version 1.09 (Grega Loboda - grega.loboda@email.si)
  ------------
  - Can hide minimized MDI cilds

  version 1.10 (Grega Loboda - grega.loboda@email.si)
  ------------
  - Can't hide minimized MDI childs if taskbar is not visible

  version 1.11 (Nugroho Edipatrianto - g06o@yahoo.com)
  ------------
  - Added two-color gradient backGround
  - Smooth transition when MDI child in maximized state

  version 1.12 (Grega Loboda - grega.loboda@email.si)
  ------------
  - Added GroupSimilar
  - Added SyncCaptions
}
...
procedure Register;
begin
  RegisterComponents('Samples', [TdsTaskBar]);
end;
